...
def add_watermark(image_path, watermark_path, output_file, transparency):
    try:
        ...
        messagebox.showerror("Error", f"Watermark addition failed: {str(e)}")
...
def hide_message(image_path, message, output_file):
    try:
        ...
        messagebox.showerror("Error", f"Message hiding failed: {str(e)}")
...
def add_qr_code(image_path, message, output_file):
    try:
        ...
        messagebox.showerror("Error", f"QR code addition failed: {str(e)}")
